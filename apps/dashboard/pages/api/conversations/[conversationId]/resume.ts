...
/** Proxy (Milestone 3, Bloco 6 — D22) para `POST /:conversationId/resume` (Bloco 5) — devolve a conversa ao bot (`status: 'bot'`). Idempotente do lado da API; devolve a `Conversation` atualizada. */
