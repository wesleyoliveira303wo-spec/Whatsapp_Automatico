 ...
 *
 * MUDANÇA DE ROTA (2026-08-29): esta tela viva em `/` desde a M6H-1; passou
 * para `/app` quando `/` virou a landing page pública. Nenhuma mudança de
 * comportamento — só o caminho. Ver `lib/routes.ts` (`APP_HOME`).
 *
...
export default function AppHome({ tenantId }: HomeProps): JSX.Element {
