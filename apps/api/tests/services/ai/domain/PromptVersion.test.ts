...
import { getPromptVersion, PROMPT_VERSIONS } from '../../../../src/services/ai/domain/PromptVersion';
...
describe('getPromptVersion', () => {
  ...
  it('lança PromptVersionNotFoundError para um id inexistente (achado F2 da auditoria do Bloco 3a)', () => {
    ...
    expect(() => getPromptVersion('versao-inexistente')).toThrow('Versão de prompt desconhecida: "versao-inexistente"');
  });
});
